...
public class User implements Serializable {
  ...
  */
  @ManyToOne
  @JoinColumn(name="fk_avalicacao", nullable = true, referencedColumnName = "id", insertable=true, updatable=true)
  
  private avalicacao avalicacao;

  /**
  * @generated
  */
  @ManyToOne
  @JoinColumn(name="fk_pontuacao", nullable = true, referencedColumnName = "id", insertable=true, updatable=true)
  ...
  public avalicacao getAvalicacao(){
    return this.avalicacao;
  }

  /**
   * Define avalicacao
   * @param avalicacao avalicacao
   * @generated
   */
  public User setAvalicacao(avalicacao avalicacao){
   ...
   * @generated
   */
  public User setPontuacao(pontuacao pontuacao){
