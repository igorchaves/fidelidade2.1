...
public interface UserDAO extends JpaRepository<User, java.lang.String> {
  ...
  public Page<loja> findLoja(@Param(value="id") java.lang.String id, Pageable pageable);
   ...
   * @generated
   */
  @Query("SELECT entity.loja FROM pontuacao entity WHERE entity.user.id = :id")
  public Page<loja> listLoja_2(@Param(value="id") java.lang.String id, Pageable pageable);
   ...
   */
  @Modifying
  @Query("DELETE FROM pontuacao entity WHERE entity.user.id = :instanceId AND entity.loja.id = :relationId")
  public int deleteLoja_2(@Param(value="instanceId") java.lang.String instanceId, @Param(value="relationId") java.lang.String relationId);

  /**
   * Foreign Key avalicacao
   * @generated
   */
  @Query("SELECT entity FROM User entity WHERE entity.avalicacao.id = :id")
  public Page<User> findUsersByAvalicacao(@Param(value="id") java.lang.String id, Pageable pageable);
  ...
  public Page<User> findUsersByPontuacao(@Param(value="id") java.lang.String id, Pageable pageable);
